...
``` java -jar maat-1.0.8.jar ```

<a name="installation-using-docker"></a>
# Installation using Docker

Maat can be run in a Docker container. The Docker image is available on the Artifactory repository at `artifactory.software.geant.org/spa-docker/maat:<actuall_version e.g. 1.0.8>`.
